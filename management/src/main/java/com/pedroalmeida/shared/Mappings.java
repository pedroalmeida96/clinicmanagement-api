...
public class Mappings {
    ...
    public static final String GET_DOCTORS_BY_ID = "/doctors/{id}";
    public static final String ADD_DOCTORS = "/doctors/add";
    public static final String DELETE_DOCTORS = "/doctors/delete/{id}";
    public static final String UPDATE_DOCTORS = "/doctors/patch";
